...
@section('content')
    ...
    <div class="container">
        <div class="offset-lg-2 col-lg-8 offset-lg-2 offset-md-2 col-md-8 offset-md-2 offset-sm-2 col-sm-8 offset-sm-2">
            ...
            <form method="" id="font-inscription" action="{{route ('centresInterets')}}" class="well" role="form">
                @csrf
                <fieldset>
                    <p class="form-group">
                    ...
                    <p class="form-group">
                        ...
                        <input id="prenom" class="form-control" placeholder="Entrez votre prénom" type="text" name="prenom"
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <input type="file" name="imgProfil" enctype="multipart/form-data">
