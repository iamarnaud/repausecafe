                ...
                <div class="row">
                    ...
                    <aside class="col-lg-6 col-md-6 col-s-6">
                        <div class="container">
                            ...
                            <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus data-validation-event="keyup" data-validation="email">
